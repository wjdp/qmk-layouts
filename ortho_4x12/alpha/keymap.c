...
[_ADJUST] = LAYOUT_ortho_4x12(
  ...
  QK_BOOT, XXXXXXX, I3_WN_L, I3_WN_D, I3_WN_R, DT_UP,   KC_VOLU, KC_LSFT, KC_LCTL, XXXXXXX, KC_PSCR, LALT(KC_BSPC),
...
const uint8_t PROGMEM colourmaps[][MATRIX_ROWS][MATRIX_COLS][3] = {
  ...
  [_ADJUST] = {
    ...
    {CL_RED, CL_OFF, CL_BLU, CL_BLU, CL_BLU, CL_TUP, CL_VUP, CL_FFF, CL_FFF, CL_OFF, CL_FFF, CL_DEL}, 
