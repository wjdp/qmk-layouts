...
[_MOUSE] = LAYOUT_ortho_4x12(
  ...
  XXXXXXX, KC_4,    KC_5,    KC_6,    XXXXXXX, XXXXXXX, KC_LCTL, MS_LEFT, MS_DOWN, MS_RGHT, KC_PGDN, XXXXXXX,
  XXXXXXX, KC_7,    KC_8,    KC_9,    XXXXXXX, XXXXXXX, KC_WBAK, KC_WFWD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  XXXXXXX, XXXXXXX, MS_ACL0, MS_ACL1, MS_ACL2, MS_BTN1, MS_BTN1, MS_BTN2, MS_BTN3, XXXXXXX, XXXXXXX, XXXXXXX
),
//  Tab  |    Q   |    W   |    E   |    R   |    T   |    Y   |    U   |    I   |    O   |    ;   |  Bksp
//  Esc  |    A   |    S   |    D   |    F   |    G   |    H   |    J   |    K   |    L   |    P   |  "
// Shift |    Z   |    X   |    C   |    V   |    B   |    N   |    M   |    ,   |    .   |    /   |  Enter
...
[_GAME_ESDF] = LAYOUT_ortho_4x12(
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
  KC_CAPS, XXXXXXX, KC_LALT, KC_LCTL, MO_GLOW, KC_SPC,  KC_SPC,  MO_GRSE, MO_WM,   XXXXXXX, XXXXXXX, I3_WN_R
),
//  Tab  |    Q   |    W   |    E   |    R   |    T   |    Y   |    U   |    I   |    O   |    ;   |  Bksp
//  Esc  |    A   |    S   |    D   |    F   |    G   |    H   |    J   |    K   |    L   |    P   |  "
// Shift |    Z   |    X   |    C   |    V   |    B   |    N   |    M   |    ,   |    .   |    /   |  Enter
...
[_GAME_LOWER] = LAYOUT_ortho_4x12(
  ...
  _______, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_LBRC, KC_RBRC, _______,
...
[_GAME_RAISE] = LAYOUT_ortho_4x12(
  ...
  _______, _______, _______, _______, _______, _______, KP_MINS, KC_4,    KC_5,    KC_6,    KC_0,    _______,
  _______, _______, _______, _______, _______, _______, KP_PLUS, KC_1,    KC_2,    KC_3,    _______, _______,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, TO_HOME
),
};
